# Intent Translator Managed Rules

- For terse, implicit, context-dependent, corrective, or consequential requests, call `intent_compile` with the exact latest wording, compact recent context, and the last explicitly proposed unfinished action before acting.
...
- Use `intent_shadow_review` during maintenance or requested review, not as an interruption to exam preparation.
