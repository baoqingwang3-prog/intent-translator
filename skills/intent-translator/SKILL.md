...
7. For complex, high-impact, or correction-prone work, run `scripts/memory_store.py intent-check` with the scoped goal and risk properties. Apply returned `watch_for` corrections before execution.
